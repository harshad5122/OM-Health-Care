...
const Contact = () => {
  ...
  return (
    <div className=" bg-[#f8fbfd] text-[#333] font-poppins overflow-x-hidden">
      {/* Hero Section */}
      <section
        className="relative h-[50vh] min-h-[350px] bg-center bg-cover bg-no-repeat flex items-center justify-center text-center text-white mb-[10px]"
...
<section
  ref={formSectionRef}
  className={`pb-20 pt-5 mb-20 transition-all duration-1000 ease-out opacity-0 translate-y-12 ${
